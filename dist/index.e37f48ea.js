...
/*  TO FUTURE ME- control.js IS THE MAIN THING, IT IS LIKE <App/>  */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _webImmediateJs = require("core-js/modules/web.immediate.js"); // window.addEventListener(`hashchange`, controlRecipe());
 // window.addEventListener(`load`, controlRecipe());
var _runtime = require("regenerator-runtime/runtime"); //async
var _modelJs = require("./model.js");
var _recipeViewJs = require("./views/recipeView.js"); //importing the obj diresctly instead of es6 class
...
const controlSearchResults = async function() {
    try {
        //spinner
        (0, _resultsViewJsDefault.default).renderSpinner(); //inheritance🌚🌚
        ...
        (0, _resultsViewJsDefault.default).render(_modelJs.getSearchResults(1));
...
const controlAddBookmark = function() {
    ...
    else _modelJs.delBookmark(_modelJs.state.recipe.id);
...
/*DON'T WONDER HOW THIS IS WORKING WITHOUT FUNCTION CALLS OPEN THE init() below.You can see that function call occurs
 but Publisher-Subscriber design principle */ const init = function() {
    (0, _recipeViewJsDefault.default).addHandlerRender(controlRecipe);
    (0, _recipeViewJsDefault.default).addHandlerUpdateServings(controlServings);
    (0, _recipeViewJsDefault.default).addHandlerAddBookmark(controlAddBookmark);
    (0, _searchViewJsDefault.default).addHandlerSearch(controlSearchResults);
    (0, _paginationViewJsDefault.default).addHandlerClick(controlBtn);
...
},{"core-js/modules/web.immediate.js":"49tUX","regenerator-runtime/runtime":"dXNgZ","./model.js":"Y4A21","./views/recipeView.js":"l60JC","./views/searchView.js":"9OQAM","./views/resultsView.js":"cSbZE","./views/paginationView.js":"6z7bi","./views/bookMarkView.js":"jpgVd","./views/addRecipeView.js":"i6DNj","./config.js":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
"use strict";
...
parcelHelpers.export(exports, "delBookmark", ()=>delBookmark);
...
const state = {
    ...
    search: {
        query: ``,
        results: [],
        resultsPerPage: (0, _config.SEARCH_PER_PAGE),
        page: 1
    },
    bookmarks: []
};
...
/*all variables that are constants and are reused in multiple places*/ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "API_URL", ()=>API_URL);
parcelHelpers.export(exports, "TIMEOUT_SEC", ()=>TIMEOUT_SEC);
parcelHelpers.export(exports, "SEARCH_PER_PAGE", ()=>SEARCH_PER_PAGE);
parcelHelpers.export(exports, "KEY", ()=>KEY);
parcelHelpers.export(exports, "MODAL_CLOSE_SEC", ()=>MODAL_CLOSE_SEC);
const API_URL = "https://forkify-api.herokuapp.com/api/v2/recipes/";
const TIMEOUT_SEC = 10;
const SEARCH_PER_PAGE = 10;
const KEY = `2c72d050-2721-482c-b46e-a14b7b087ef2`;
...
class RecipeView extends (0, _viewDefault.default) {
    ...
    addHandlerRender(handler) {
        // [`haschange`, `load`].forEach(e => window.addEventListener(e, handler));
        [
            "hashchange",
            "load"
   ...
   <div class="recipe__details">
     ...
     <div class="recipe__info">
       ...
       <span class="recipe__info-datathis.#data__info-data--people">${this._data.servings}</span>
...
class View {
    ...
    // algorithm not to render  everything when servings are updated
    update(data) {
        this._data = data;
        ...
        newElems.forEach((newElem, i)=>{
            let curEl = curElems[i];
            //console.log(curEl, newElem.isEqualNode(curEl));
            // updating text that changes
            if (!newElem.isEqualNode(curEl) && newElem?.firstChild?.nodeValue.trim() !== "") //console.log(`🌚🌚 ${newElem.firstChild.nodeValue.trim()}`);
            curEl.textContent = newElem.textContent;
            //updating attributes
            if (!newElem.isEqualNode(curEl)) // console.log(Array.from(newElem.attributes));
            Array.from(newElem.attributes).forEach((atttr)=>curEl.setAttribute(atttr.name, atttr.value));
        });
    }
    _clear() {
...
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
/*This class will not render anything it gets the data from the input Value */ class SearchView extends (0, _viewDefault.default) {
...
/* this class will reender the search results */ /* Very much similar to recipieView so let's create  aprent class and resultsView and recipeView will be children */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
class ResultsView extends (0, _viewDefault.default) {
    ...
    _errorMessage = `Let's cook something else \u{1F31A}\u{1F31A}`;
    _generateMarkeup() {
...
/*preview View is going to be parent class for resultsView and bookMarks View */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class Previewiew extends (0, _viewDefault.default) {
    _parentElement = "";
    _errorMessage = `Let's cook something else \u{1F31A}\u{1F31A}`;
    _generateMarkeup() {
        const id = window.location.hash.slice(1);
...
exports.default = new Previewiew();
...
},{"./View":"5cUXS","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jpgVd":[function(require,module,exports) {
/* this class will reender the search results */ /* Very much similar to recipieView so let's create  aprent class and resultsView and recipeView will be children */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
class AddRecipeView extends (0, _viewDefault.default) {
    ...
    _message = `Recipe addded successfully \u{1F31A}\u{1F31A}`;
    constructor(){
        super();
